...
class UpdateReviewComponent extends PureComponent {
    constructor(props) {
        super(props)

        this.state = {
            reviewId: this.props.match.params.bookId,
            book: '',
            customerId: '',
            headLine: '',
            comment: '',
                                ...
                                <form>
                                    ...
                                    <div className='form-group'>
                                        ...
                                        <input type='text' placeholder='Category Name' name='categoryName' className='form-control'
                                            value={this.state.categoryNamey} onChange={this.changeCategoryName}></input>
                                    </div>
                                    <div className='form-group'>
