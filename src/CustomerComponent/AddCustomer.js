        ...
        return (
            <div>
                <div className='container'>
                    <div className='row'>
                        <div className='ard col-md-6 offset-md-3 offset-md-3' style=''>
                            <h3 className='text-center'><b>ADD CUSTOMER</b></h3>
                            <div className='card-body'>
                                <form name='addcustomer' className='add-customer' actions="">
                                    ...
                                    <div className='form-group'>
                                        ...
                                        <input type='text' placeholder='Address' className='form-control'
                                            value={this.state.address.address} onChange={this.changeAddress}></input>
                                    </div>
                                    <div className='form-group'>
                                        <label>City:</label>
