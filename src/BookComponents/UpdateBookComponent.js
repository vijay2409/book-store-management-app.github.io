...
class UpdateBookComponent extends PureComponent {
    constructor(props) {
        super(props)
    ...
    // componentDidMount() {
    //     BookService.listBooksByCategory(this.state.categoryName).then((res) => {
    //         let book = res.data;
    //         this.setState({
    //             title: book.title,
    //             author: book.author,
                        ...
                        <div className='row'>
                            <div className='ard col-md-6 offset-md-3 offset-md-3'>
                                ...
                                <div className='card-body'>
                                    <form name='addbook' className='add-customer'>
                                        <div className='form-group'>
                                            <label>Title:</label>
                                            <input type='text' minLength="3"  placeholder='Title' name='title' className='form-control'
